...
const PreparationMaterials = () => {
  ...
  return (
    <CandidateLayout
      ...
      subtitle="Use these resources to strengthen aptitude, technical, and interview performance."
    >
      <section className="candidate-panel">
        <p className="materials-intro">Click any resource to open it in a new tab.</p>
